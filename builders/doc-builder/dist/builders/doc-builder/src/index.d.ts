...
export declare class DocBuilder implements MishtiBuilderWorker {
    ...
    executeTask(task: BuilderTaskIntakeContract): Promise<BuilderResultContract>;
...
export declare const docBuilder: DocBuilder;
