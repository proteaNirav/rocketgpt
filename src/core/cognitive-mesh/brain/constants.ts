export const WORKING_MEMORY_KEYS = {
...
export const REASONING_CONTEXT_TYPES = {
...
export type WorkingMemoryKey = (typeof WORKING_MEMORY_KEYS)[keyof typeof WORKING_MEMORY_KEYS];
export type ReasoningContextType = (typeof REASONING_CONTEXT_TYPES)[keyof typeof REASONING_CONTEXT_TYPES];
