import type { ExperienceCaptureFacts, ExperienceOutcome } from "../types/experience.types";

function hasGuardrail(circumstances: ExperienceCaptureFacts["circumstances"], action: ExperienceCaptureFacts["action"]): boolean {
  return (
    circumstances.guardrailApplied ||
...
export function classifyExperienceOutcome(facts: ExperienceCaptureFacts): ExperienceOutcome {
