...
import { SessionBrain } from "../brain/session-brain";

test("session brain snapshot contains normalized sections and counts", () => {
  const brain = new SessionBrain("session-snapshot");
