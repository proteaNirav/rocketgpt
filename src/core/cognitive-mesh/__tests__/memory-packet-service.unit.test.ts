...
test("memory packet generation enforces minimum sufficient filtered payload", () => {
...
test("memory packet excludes suppressed/rejected adopted memories from selection", () => {
  const service = new CognitiveMemoryService();
