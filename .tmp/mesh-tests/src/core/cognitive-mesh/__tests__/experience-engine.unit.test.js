...
(0, node_test_1.test)("experience engine tags verified successful execution as execution_success", () => {
...
(0, node_test_1.test)("experience engine maps fallback/degraded path to execution_degraded", () => {
    const service = new cognitive_experience_capture_service_1.CognitiveExperienceCaptureService(new in_memory_experience_repository_1.InMemoryExperienceRepository(100));
    const result = service.captureExecutionExperience(baseFacts({
        action: {
            capabilityId: "cap.language.v1",
...
(0, node_test_1.test)("experience engine maps verification rejection to verification_rejection", () => {
    const service = new cognitive_experience_capture_service_1.CognitiveExperienceCaptureService(new in_memory_experience_repository_1.InMemoryExperienceRepository(100));
    const result = service.captureExecutionExperience(baseFacts({
        action: {
            capabilityId: "cap.language.v1",
...
(0, node_test_1.test)("experience engine maps drift signal to drift_detected", () => {
    const service = new cognitive_experience_capture_service_1.CognitiveExperienceCaptureService(new in_memory_experience_repository_1.InMemoryExperienceRepository(100));
    const result = service.captureExecutionExperience(baseFacts({
...
(0, node_test_1.test)("experience engine maps strong reinforcement delta to reinforcement_positive", () => {
    const service = new cognitive_experience_capture_service_1.CognitiveExperienceCaptureService(new in_memory_experience_repository_1.InMemoryExperienceRepository(100));
    const result = service.captureExecutionExperience(baseFacts({
