...
(0, node_test_1.test)("memory adoption adopts valid verified success deterministically", () => {
    const service = new memory_adoption_service_1.MemoryAdoptionService();
...
(0, node_test_1.test)("memory adoption downgrades degraded success with quality markers", () => {
    const service = new memory_adoption_service_1.MemoryAdoptionService();
...
(0, node_test_1.test)("memory adoption rejects non-adoptable and invalid candidates", () => {
    const service = new memory_adoption_service_1.MemoryAdoptionService();
...
(0, node_test_1.test)("memory adoption suppresses candidates when integrity/drift signals are present", () => {
    const service = new memory_adoption_service_1.MemoryAdoptionService();
