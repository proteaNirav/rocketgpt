...
(0, node_test_1.test)("motivated recall suppressed when below low threshold", () => {
    const engine = new motivated_recall_engine_1.MotivatedRecallEngine({ thresholdLow: 0.5, thresholdHigh: 0.8 });
...
(0, node_test_1.test)("motivated recall selects implicit between thresholds", () => {
    const engine = new motivated_recall_engine_1.MotivatedRecallEngine({ thresholdLow: 0.4, thresholdHigh: 0.75 });
    const decision = engine.decide({
...
(0, node_test_1.test)("motivated recall prefers explicit when risk indicator is high", () => {
    const engine = new motivated_recall_engine_1.MotivatedRecallEngine({ thresholdLow: 0.4, thresholdHigh: 0.7 });
    const decision = engine.decide({
