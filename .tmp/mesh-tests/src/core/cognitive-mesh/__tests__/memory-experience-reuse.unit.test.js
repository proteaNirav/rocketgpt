...
function makeExperience(sessionId, id, status, classification) {
    return {
        experienceId: id,
...
(0, node_test_1.test)("experience-informed reuse scoring biases synthesized memory selection", () => {
    ...
    const service = new cognitive_memory_service_1.CognitiveMemoryService(undefined, {
