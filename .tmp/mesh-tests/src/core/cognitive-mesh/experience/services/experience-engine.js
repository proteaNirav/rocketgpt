...
exports.ExperienceEngine = void 0;
...
function classifyExperience(record) {
    const signals = new Set(record.relatedSignals);
    const hasVerificationRejection = record.verification.verdict === "reject" ||
...
function scoreExperience(record, classification) {
    let score = 0.5;
    let confidence = 0.6;
...
exports.ExperienceEngine = ExperienceEngine;
