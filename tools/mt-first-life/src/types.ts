...
export interface GovernanceState {
  ...
  decisions: Array<GovernanceDecision & { taskId: string; checkedAt: string; eligibility: GovernanceEligibility }>;
}
...
export interface AwarenessState {
  ...
  unsafeTrustSignals: Array<{ actorId: string; posture: string; reason: string }>;
}
