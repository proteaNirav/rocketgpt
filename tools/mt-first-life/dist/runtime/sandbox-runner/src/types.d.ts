...
import type { EventGapReport, LineageInconsistencyReport } from "../../../shared/event-model/types.js";
...
export interface SandboxRunnerBoundary {
    ...
    interruptForSurvival(requestId: string, survivalState: Extract<SurvivalState, "safe_mode" | "emergency_stop" | "node_isolated">): ExecutionResultEnvelope;
}
