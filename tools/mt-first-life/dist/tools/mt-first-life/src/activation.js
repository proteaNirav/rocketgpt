...
import { getRepoRoot, initializeState, loadBuildersState, loadGovernanceState, loadRuntimeState, loadTasksState, saveGovernanceState, saveRuntimeState, saveTasksState, } from "./state.js";
...
export async function createTaskFromDraft(draft) {
    await initializeState();
...
export async function setSurvivalState(state) {
    const runtimeState = await loadRuntimeState();
