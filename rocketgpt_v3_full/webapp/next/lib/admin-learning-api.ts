...
export async function reviewLearningItem(itemId: string, decision: "approve" | "reject" | "revoke" | "deprecate", rationale?: string): Promise<void> {
...
export async function publishLearningItem(itemId: string, libraryId: string): Promise<{ filePath: string }> {
...
export async function updateLearningSource(sourceId: string, patch: {
  name?: string;
  sourceUrl?: string | null;
  enabled?: boolean;
  intervalMinutes?: number;
