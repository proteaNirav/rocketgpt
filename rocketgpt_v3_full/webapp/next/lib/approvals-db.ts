...
function matchesFilter(approval: ApprovalRecord, filter?: ListApprovalsFilter): boolean {
...
export async function updateApprovalStatus(
  ...
  try {
    ...
    const eventType: ApprovalEventType = status === 'approved' ? 'approved' : 'rejected'
...
export async function listApprovals(filter?: ListApprovalsFilter): Promise<ApprovalRecord[]> {
  try {
