...
test('RGPT_B17_FAILPROOF', async () => {
  throw new Error('RGPT_B17_FAILPROOF')
})
...
test.skip('POST /api/orchestrator/builder/execute-all returns a JSON payload', async ({
  request,
}) => {
...
test('POST /api/orchestrator/builder/execute-all returns 400 for invalid input', async ({
  request,
}) => {
