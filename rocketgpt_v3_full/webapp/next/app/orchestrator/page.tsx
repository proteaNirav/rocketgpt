...
export default function OrchestratorPage() {
  ...
  const orchOk =
    (resp?.success === true) ||
    (resp?.tester?.success === true) ||
    (resp?.builder?.success === true);
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="rounded-xl border border-gray-800 p-6 bg-black/30 space-y-4">
        ...
        <p className="text-sm text-gray-400">
          This console calls <code>/api/orchestrator/run</code> and shows the
          stubbed Planner → Builder → Tester pipeline. Later this will be wired
          to the real agents and database.
        </p>
