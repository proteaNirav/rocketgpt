  ...
  return (
    <div className="p-6">
      ...
      <div className="space-y-3">
        {mockLogs.map((log) => (
          <div key={log.id} className="rounded-lg border border-gray-700 bg-gray-900 p-4">
            <p className={`font-semibold ${levelColor[log.level]}`}>[{log.level.toUpperCase()}]</p>
      ...
      <p className="mt-6 text-xs text-slate-400">
        This is a placeholder view. Live logs will come from the backend / GitHub Actions pipelines
        and internal self-heal events.
      </p>
    </div>
  )
}
