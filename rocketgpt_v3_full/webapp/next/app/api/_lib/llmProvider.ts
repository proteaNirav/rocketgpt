...
const OPENAI_MODEL_CANDIDATES = ['gpt-4.1-mini', 'gpt-4o-mini', 'gpt-4.1', 'gpt-4o']
 ...
 */
export async function completeChatWithFallback(messages: LLMMessage[]): Promise<string> {
