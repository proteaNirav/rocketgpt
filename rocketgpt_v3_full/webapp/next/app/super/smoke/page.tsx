  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <StatusCard title="Health Endpoint" value={health.ok ? "OK" : "FAIL"} bad={!health.ok} hint={health.error ?? ""} />
        ...
        <StatusCard title="Limits API" value={limits.ok ? "OK" : "FAIL"} bad={!limits.ok} hint={limits.error ?? ""} />
      </div>
