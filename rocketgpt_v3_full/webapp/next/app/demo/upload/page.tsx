  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-start p-4 gap-4">
      <div className="w-full max-w-3xl border rounded-xl p-4 shadow-sm bg-white/80 dark:bg-neutral-900/80">
        <h1 className="text-2xl font-semibold mb-2">RocketGPT Demo Upload & Ingestion</h1>
        <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
          ...
          . The backend currently only counts files and returns a JSON response. Later, you can wire
          this to your real ingestion/orchestration flow (e.g. saving to Supabase, knowledge
          library, or test automation pipelines).
        </p>
        ...
        {status && <div className="mt-2 text-xs text-green-600 dark:text-green-400">{status}</div>}
        {error && (
