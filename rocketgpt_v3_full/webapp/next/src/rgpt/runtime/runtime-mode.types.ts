export type RuntimeMode = 'OFFLINE' | 'SAFE' | 'SUPERVISED' | 'AUTONOMOUS' | 'SELF_EVOLUTION' // LOCKED, do not enable in S3

export type DowngradeTrigger = 'policyViolation' | 'unexpectedDrift' | 'ciInstability'
